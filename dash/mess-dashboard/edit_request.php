...
$sql1 ="update menu set menu = '".$menu."',category = '".$category."' where id=".$id;
//$sql1 ="update menu set menu = '".$menu."',category = '".$category."';

if ($conn->query($sql1)) {
    echo "<script type='text/javascript'>alert('Request is updated !!!');document.location='viewmenu.php';</script>";
  
}else {
    echo "<script type='text/javascript'>alert('error');document.location='viewmenu.php';</script>";
    } 
 }                        
?>
        <!DOCTYPE html>
                                                ...
                                                <!--<div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="year" id="Year">
                                                            ...
                                                            <option value="2021">Breakfast</option>
                                                            <option value="2022">Lunch </option>
                                                            <option value="2023">Dinner</option>
                                                        </select>
                                                    </div>
                                                </div>-->
                                            </div>

                                            <button type="submit" name="update" class="btn btn-primary pull-right">Update Menu</button>
