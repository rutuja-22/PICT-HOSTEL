...
if (isset($_SESSION['id'])) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        if ($row['feespaid'] == 'Yes') {
            echo '<script>document.location="bookhostel.php";</script>';
        } else {
?>
                        ...
                        <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top " id="navigation-example">
                            <div class="container-fluid">
                                <div class="navbar-wrapper">
                                    <a class="navbar-brand" href="javascript:void(0)">Checkout</a>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            <div class="card-header card-header-primary">
                                                <h4 class="card-title">Room Booking Process</h4>
                                                <!-- <p class="card-category">Complete your profile</p> -->
                                            </div>
                                            <div class="card-body">
                                                <form id="main" method="post" action="checkout.php">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control" name="roomtype" id="roomtype">
                                                                    <option value="">Select the type of Room you want</option>
                                                                    <option value="Attached">Double occupancy with attached WC: Rs. 1,20,000</option>
                                                                    <option value="Common">Double occupancy with Common WC: Rs. 1,10,000</option>
                                                                    <!-- <option value="ENTC">ENTC</option> -->
                                                                </select>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-8">
                                                            If you want to see the room You can come to collage or see the pictures
                                                            <a href="http://">here</a>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <button type="submit" name="submit" class="btn btn-primary pull-right">
                                                                <?php echo "<a style='outline-style: none; color:white;'onClick=\"return confirm('Are you sure you want to Proceed?')\"> Proceed </a>"; ?>
                                                            </button>
                                                        </div>
