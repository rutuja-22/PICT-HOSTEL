...
if (isset($_POST['submit'])) {
    ...
    $sql1 = "insert into leave_details(id,studname,outime,intime,reason,mess,status) values('$id','$studname','$outime','$intime','$reason','$chk','Pending')";
    if ($conn->query($sql1)) {
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="datetime-local" class="form-control" id="outime" name="outime" value="">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
