                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header card-header-primary">
                                    <h4 class="card-title">Pending Leave Details</h4>
                                    ...
                                    <div class="table-responsive dt-responsive">
                                        <table id="example" class="table table-striped table-bordered nowrap">
                                            <thead>
                                                ...
                                                <th>
                                                    <p style="font-weight:bold">Leaving from</p>
                                                </th>
                                                <th>
                                                    <p style="font-weight:bold">Arriving on</p>
                                                </th>
                                                <th>
                                                ...
                                                <th>
                                                    <p style="font-weight:bold">Leave Apply time</p>
                                                </th>
                                                <th>
                                            ...
                                            <tbody>
                                                ...
                                                $sql = "SELECT * from leave_details where status = 'Pending' ";
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php if($new == $date1){ echo "Today";}else echo $row['created_at']; ?>
                                                        </td>
                                                        <td>
                                                            <button  type="button" class="btn-success"><?php echo"<a style='outline-style: none; color:white;' href=\"approve_leave.php?sr_no=$row[sr_no]\" onClick=\"return confirm('Are you sure you want to Approve?')\">Approve</a>";?></button>
                                                            <button type="button" class="btn-danger"><?php echo"<a style='outline-style: none; color:white;' href=\"deny_leave.php?sr_no=$row[sr_no]\" onClick=\"return confirm('Are you sure you want to Deny?')\">Deny</a>";?></button>
                                                        </td>
                                                    </tr>
                                                <?php $i++;
                                                } ?>
