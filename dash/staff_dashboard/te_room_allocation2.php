...
if (isset($_POST['submit'])) {
    ...
    $sql = "Select * from tebookings2 where room_no='$roomno'";
    $result = mysqli_query($conn, $sql);
    if (mysqli_num_rows($result) > 0) {
        ...
        if ($row2['status'] == "Available") {
            ...
            if ($result1) {
                $sql2 = "UPDATE tebookings2 SET name='$yname',regid='$regid',city='$city',status='Occupied' WHERE room_no='$roomno'";
                ...
                echo "<script type='text/javascript'>alert('error');document.location='te_room_allocation2.php';</script>";
            }
        } else {
            echo "<script type='text/javascript'>alert('Room is already booked!!!');document.location='te_room_allocation2.php';</script>";
        }
    }
} ?>
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form id="main" method="post" action="te_room_allocation2.php" enctype="multipart/form-data">
                                                <div class="row">
                                                    <div class="col-md-6">
