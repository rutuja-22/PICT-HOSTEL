...
if (isset($_POST['submit'])) {
    ...
    $sql = "Select * from sebookings where room_no='$roomno'";
    $result = mysqli_query($conn, $sql);
    if (mysqli_num_rows($result) > 0) {
        ...
        if ($row2['status'] == "Available") {
            ...
            if ($result1) {
                $sql2 = "UPDATE sebookings SET name='$yname',regid='$regid',city='$city',status='Occupied' WHERE room_no='$roomno'";
                $result2 = mysqli_query($conn, $sql2);
                if ($result2) {
                    $sql3 = "DELETE FROM roomchange WHERE regid='$regid'";
                    $result3 = mysqli_query($conn, $sql3);
                    // echo "$result3";
                    echo "<script type='text/javascript'>alert('Room Booked Successfully !!!');document.location='room_reg.php';</script>";
                }
            } else {
                echo "<script type='text/javascript'>alert('error');document.location='se_room_allocation.php';</script>";
            }
        } else {
            echo "<script type='text/javascript'>alert('Room is already booked!!!');document.location='se_room_allocation.php';</script>";
        }
    }
} ?>
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form id="main" method="post" action="se_room_allocation.php" enctype="multipart/form-data">
                                                <div class="row">
                                                    <div class="col-md-6">
