...
if (isset($_POST['submit'])) {
    ...
    $sqlp = "insert into notice(title,description) value('$title','$desc')";
                    ...
                    PICT HOSTEL
                            ...
                            <a class="nav-link" href="./Registered_Students.php">
                                ...
                                <p>Registered Students</p>
                                        ...
                                        <li class="nav-item ">
                                            <a class="nav-link" href="./oleavedetails.php">
                                        ...
                                        <li class="nav-item active">
                                            <a class="nav-link" href="./notice.php">
                                                <i class="material-icons">notice</i>
                                                <p>Notice</p>
                                            </a>
                                        </li>
                                    </ul>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="desc"  required="">
                                                                ...
                                                                <!--<div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label class="bmd-label-floating"></label>
                                                                        <input type="date" date-date_format="YYYY-MM-DD" class="form-control" name="date" required="">
                                                                    </div>
                                                                </div>-->

                                                            </div>

                                                            <button type="submit" name="submit" class="btn btn-primary pull-right">Add Notice</button>
