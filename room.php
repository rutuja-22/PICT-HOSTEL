...
if (isset($_POST['submit'])) {
    ...
    $otp = $_POST['otp'];
    $sql = "insert into sebookings2(regid,name,city,room_no,status,details,cancel_req)values ('','','','$otp','Available','It is having indoor toilet & contain AC','No')"; 
    // $sql = "insert into pincode(pincode)values ('$otp')";       
