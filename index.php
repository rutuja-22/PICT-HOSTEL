        ...
        <div class="popup">
            <div class="signup-form">
                ...
                <form action="login.php" method="post">
                    ...
                    <div class="form-group">
                        <input type="password" id="id_password" autocomplete="current-password" class="form-control" name="password" placeholder="Password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required="required" />
                        <p>
                            <i class="far fa-eye" id="togglePassword" style="margin-left: -30px; margin-bottom: 20px; cursor: pointer;"></i>
                        </p>
                    </div>
        ...
        <div class="popup1">
            <div class="signup-form">
                ...
                <form action="forgot.php" method="post">
                    ...
                    <div class="form-group">
                        <input type="email" class="form-control" name="email" placeholder="Email" pattern="[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$" required="required" />
                    </div>
                    ...
                    <div class="col-lg-6" data-aos="fade-right" data-aos-delay="100">
                        ...
                        <div class="card">
                            ...
                            <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordion">
                                <div class="card-body">
                                    <p1>Total accommodation: 67 Rooms (with double occupancy)</p1>
                                    <p>Allotment will be as follows:</p>
                                    <table class="table table-bordered table-hover">
                                        <tbody>
                                            <tr>
                                                <td>FE/SE(Direct)/ME-I</td>
                                                <td>66 students</td>
                                            </tr>
                                            <tr>
                                                <td>SE</td>
                                    ...
                                    <p><b>Charges: </b>
                                        <br />1) Double occupancy with attached WC: Rs. 1,20,000
                                        <br />2) Double occupancy with Common WC: Rs. 1,10,000
                                        <br />3) Refundable Deposit: Rs. 15,000
                                        <br /><br /><b>Note:</b>
                                        <br />Other facilities like hot water, internet facility, medical officer, hostel mess & canteen, indoor and outdoor sports facilities including gymnasium, 2 wheeler parking, generator back up.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-left" data-aos-delay="200">
                        <div class="card">
                            <div class="card-header" id="headingOne">
                                <h3 class="acdn-title" data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                                    <span>Girls Hostel</span>
                                </h3>
                            </div>
                            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                                <div class="card-body">
                                    <p1>Total accommodation: 106 Rooms (with double occupancy)</p1>
                                    <p>Allotment will be as follows:</p>
                                    <table class="table table-bordered table-hover">
                                        <tbody>
                                            <tr>
                                    ...
                                    <p><b>Charges: </b>
                                        ...
                                        <br />3) Refundable Deposit: Rs. 15,000
                                        <br /><br /><b>Note:</b>
                                        <br />Other facilities like hot water, elevator, internet facility, medical officer, hostel mess & canteen, indoor and outdoor sports facilities including gymnasium, 2 wheeler parking, generator back up.
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-lg-8 mt-5 mt-lg-0" data-aos="fade-left">
                        <form action="forms/contact.php" method="post" role="form" class="php-email-form">
                            ...
                            <div class="form-group mt-3">
                                <textarea class="form-control" style="height: 74px;" name="message" rows="5" placeholder="Message" required></textarea>
                            </div>
                            <div class="my-3">
